...
var FlipDown = function() {
  ...
  return _createClass(a, [{
    ...
    value: function a() {
      return 0 > this.epoch - this.now ? (this.countdownEnded = !0,
      null != this.hasEndedCallback && (this.hasEndedCallback(),
        this.hasEndedCallback = null),
        !0) : (this.countdownEnded = !1,
        !1)
    }
  }, {
    key: "_parseOptions",
    value: function c(a) {
      ...
      return a.headings && 4 === a.headings.length && (b = a.headings),
        {
          theme: a.hasOwnProperty("theme") ? a.theme : "dark",
          headings: b
        }
    }
  }, {
    ...
    value: function e() {
      ...
      this.clockStrings.d = pad(this.clockValues.d, 2),
        ...
        d ? (a.call(this),
          b.call(this)) : (setTimeout(a.bind(this), 500),
